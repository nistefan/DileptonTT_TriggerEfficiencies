...
######################### If Electron, let's check if inputTree.passes the chosen selections
######################### ============================================================
...
#                         subleadingLepton.SetPtEtaPhiE(inputTree.eve.lepton_pt_[subleadingLeptonIndex], inputTree.eve.lepton_eta_[subleadingLeptonIndex], inputTree.eve.lepton_phi_[subleadingLeptonIndex], inputTree.eve.lepton_e_[subleadingLeptonIndex])
                    ...
                    if leadingLepton.Pt() >= 25. and subleadingLepton.Pt() >= 15. and dilepton.M() > 20.:
                         ...
                         if (inputTree.lepPdgId[leadingLeptonIndex] * inputTree.lepPdgId[subleadingLeptonIndex] == -169):
                              ...
                              if HLT_SingleMuon_ or HLT_DoubleMuon_:
                              ...
                              if not isMC:
                                   ...
                                   mumu_Channel_data_njet_nvertex_met.append([numberOfJets, numberOfPrimaryVertices, met, MuonTriggersfired, HLT_SingleMuon_])
                              else:
                                   ...
                                   mumu_Channel_MC_njet_nvertex_met.append([numberOfJets, numberOfPrimaryVertices, met, MuonTriggersfired, HLT_SingleMuon_])
                         ...
                         # if this passes we have an OS electron pair --> ee Channel
                              ...
                              if HLT_SingleElectron_ or HLT_DoubleElectron_:
                              ...
                              if not isMC:
                                   ...
                                   ee_Channel_data_njet_nvertex_met.append([numberOfJets, numberOfPrimaryVertices, met, ElectronTriggersfired, HLT_SingleElectron_])
                              else:
                                   ...
                                   ee_Channel_MC_njet_nvertex_met.append([numberOfJets, numberOfPrimaryVertices, met, ElectronTriggersfired, HLT_SingleElectron_])
                         # if this passes we have an OS electron & muon --> emu Channel
                              ...
                              if HLT_SingleElectron_ or HLT_SingleMuon_ or HLT_EMu_:
                                   ElectronMuonTriggersfired = True
                              if HLT_SingleElectron_ or HLT_SingleMuon_:
