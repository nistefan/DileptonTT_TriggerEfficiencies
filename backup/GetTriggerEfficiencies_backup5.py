...
####  No TEfficiency with weighted events for frequentists.
...
####  Thus no ROOT might be the solution.
####  Switching on the brain and coding it rather myself ...
####  
...
whichDileptonTriggerGroup = ["HLT_DoubleMuon", "HLT_DoubleElectron", "HLT_ElectronMuon", 
                             "HLT_DoubleMuon_WITH_SLtrigger", "HLT_DoubleElectron_WITH_SLtrigger", "HLT_ElectronMuon_WITH_SLtrigger",]
...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
            ...
            ### ~~~~~~~~~~~~~~~ Run dependent trigger handling ~~~~~~~~~~~~~~~~~~~~~~
            if year == "2017":
                 if isRun == "B": 
                      Trigger_DoubleMuon = []
...
################### ======================================================= 
 ...
 #               for item_Trigger_2017 in Trigger_2017:
  #                   print("it."+item_Trigger_2017[:-1])
   #                  print(eval("it."+item_Trigger_2017[:-1]))
    #                 if eval("it."+item_Trigger_2017[:-1]) == 1:
#                          eval("count_"+str(item_Trigger_2017)) += 1
     #                     globals()[item_Trigger_2017] = True
      #                    globals()["count_"+str(item_Trigger_2017)] += 1
#                          eval(str(item_Trigger_2017)) = True
